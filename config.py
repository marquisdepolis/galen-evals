...
q_db = 'files/questions_db.xlsx'
q_orig_db = 'files/questions_original_db.xlsx'
llmresults_file_path_db = f'files/{F_NAME}_results_grouped_by_model_db.xlsx'
gpt4results_csv_path_db = f'files/{F_NAME}_results_gpt4_db.xlsx'
results_file_path_db = f'files/{F_NAME}_allresults_grouped_by_model_db.xlsx'
combined_file_path_db = f'files/{F_NAME}_results_grouped_by_question_db.xlsx'
llmeval_results_db = f'{F_NAME}_llmeval_results_db.xlsx'
model_rankings_db = f'{F_NAME}_model_rankings_db.xlsx'